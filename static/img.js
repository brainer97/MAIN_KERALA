...
const OPENAI_API_KEY = "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"; // Your OpenAI API key here
...
const handleImageGeneration = (e) => {
  ...
  const imgCardMarkup = Array.from({ length: userImgQuantity }, () =>
      `<div class="img-card loading">
        <img src="static/assets/images/loader.svg" alt="AI generated image">
        <a class="download-btn" href="#">
          <img src="static/assets/images/download.svg" alt="download icon">
        </a>
      </div>`
  ).join("");
